...
from public.teams h, public.teams a where h.name = 'Montarsolo' and a.name = 'Tama';
...
from public.teams h, public.teams a where h.name = 'Martino Gonzalez' and a.name = 'Montarsolo';
...
from public.teams h, public.teams a where h.name = 'Amatori Calcio Genova' and a.name = 'Montarsolo';
