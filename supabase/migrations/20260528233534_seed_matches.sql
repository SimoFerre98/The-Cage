...
insert into public.matches (home_team_id, away_team_id, match_date, round, status, home_score, away_score)
select h.id, a.id, '2026-06-23 19:30:00+02'::timestamptz, 'Fase a Gironi', 'PROSSIMA', null, null from public.teams h, public.teams a where h.name = 'Taverna' and a.name = 'Aston Birra';
insert into public.matches (home_team_id, away_team_id, match_date, round, status, home_score, away_score)
...
insert into public.matches (home_team_id, away_team_id, match_date, round, status, home_score, away_score)
select h.id, a.id, '2026-06-23 21:15:00+02'::timestamptz, 'Fase a Gironi', 'PROSSIMA', null, null from public.teams h, public.teams a where h.name = 'Chainz' and a.name = 'Taverna';
insert into public.matches (home_team_id, away_team_id, match_date, round, status, home_score, away_score)
...
insert into public.matches (home_team_id, away_team_id, match_date, round, status, home_score, away_score)
select h.id, a.id, '2026-06-25 20:40:00+02'::timestamptz, 'Fase a Gironi', 'PROSSIMA', null, null from public.teams h, public.teams a where h.name = 'FC Pontos' and a.name = 'Taverna';
insert into public.matches (home_team_id, away_team_id, match_date, round, status, home_score, away_score)
...
insert into public.matches (home_team_id, away_team_id, match_date, round, status, home_score, away_score)
select h.id, a.id, '2026-06-25 22:25:00+02'::timestamptz, 'Fase a Gironi', 'PROSSIMA', null, null from public.teams h, public.teams a where h.name = 'Amatori Calcio Genova' and a.name = 'Taverna';
