  ...
  return (
    <div className="flex flex-col gap-12">
      ...
      <div className="w-full mt-10 flex flex-col items-stretch animate-[slideUpFade_0.6s_var(--ease-apple)] delay-150">
        ...
        {/* Chips Toggle Locale */}
        <div className="flex justify-center w-full" style={{ marginTop: '96px', marginBottom: '96px' }}>
        ...
        <div className="flex justify-center w-full px-4" style={{ marginTop: '80px', marginBottom: '96px' }}>
